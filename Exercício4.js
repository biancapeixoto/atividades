...
console.log("Percentual SP: " + sp * 100 / total + "%");
console.log("Percentual RJ: " + rj * 100 / total + "%");
console.log("Percentual MG: " + mg * 100 / total + "%");
console.log("Percentual ES: " + es * 100 / total + "%");
console.log("Percentual Outros: " + outros * 100 / total + "%");